...
#PR_USER_SID = CHANGE_PROP_TYPE(ptagSearchState, PT_BINARY)
...
#PR_CONVERSION_STATE = CHANGE_PROP_TYPE(ptagAdminNickName, PT_LONG)
PR_HTML = PROP_TAG(PT_BINARY, 0x1013) # CHANGE_PROP_TYPE(PR_BODY_HTML, PT_BINARY)
...
PR_INTERNET_MDNS = PROP_TAG(PT_BOOLEAN, pidAdminMin+0x15) # CHANGE_PROP_TYPE(PR_NEWSGROUP_COMPONENT, PT_BOOLEAN)
...
PR_MESSAGE_SIZE_EXTENDED = PROP_TAG(PT_I8, 0x0E08) # CHANGE_PROP_TYPE(PR_MESSAGE_SIZE, PT_I8)
...
PR_ATTACH_CONTENT_ID_W = PROP_TAG(PT_UNICODE,0x3712)
PR_ATTACH_CONTENT_LOCATION = PROP_TAG(PT_TSTRING,0x3713)
PR_ATTACH_CONTENT_LOCATION_W = PROP_TAG(PT_UNICODE,0x3713)
...
PR_EC_IMAP_BODY_W = 				PROP_TAG(PT_UNICODE,	PR_EC_BASE+0x8E)
PR_EC_IMAP_BODYSTRUCTURE =		PROP_TAG(PT_STRING8,	PR_EC_BASE+0x8F)
PR_EC_IMAP_BODYSTRUCTURE_W =		PROP_TAG(PT_UNICODE,	PR_EC_BASE+0x8F)
...
PS_COMMON = DEFINE_OLEGUID(0x00062008, 0, 0)
PS_ARCHIVE = DEFINE_GUID(0x72e98ebc, 0x57d2, 0x4ab5, 0xb0, 0xaa, 0xd5, 0x0a, 0x7b, 0x53, 0x1c, 0xb9)
