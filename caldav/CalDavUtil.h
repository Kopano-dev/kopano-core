...
extern HRESULT HrAuthenticate(const std::string & appVersion, const std::string & appMisc, const std::wstring &wstrUser, const std::wstring &wstrPass, std::string strPath, IMAPISession **lpSession);
...
extern HRESULT HrFindFolder(IMsgStore *, IMAPIFolder *root, SPropTagArray *lpNamedProps, std::wstring wstrFldId, IMAPIFolder **lppUsrFld);
