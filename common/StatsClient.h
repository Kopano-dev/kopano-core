...
enum SCName {
	...
	SCN_DAGENT_AUTOACCEPT_TIME,
	SCN_DAGENT_AUTOPROCESS,
	SCN_DAGENT_AUTOPROCESS_TIME,
	...
	SCN_DAGENT_DELIVERY_PROCESSING_TIME,
	...
	SCN_SERVER_USERDB_BACKEND, SCN_SERVER_ATTACH_BACKEND,
	SCN_DATABASE_MAX_OBJECTID,
};
