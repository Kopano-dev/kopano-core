...
setup(name='kopano-rules',
      version=metadata['version'],
      url='https://kopano.io',
      description='Kopano server-side rule management CLI',
      long_description='Kopano server-side rule management CLI',
      author='Kopano',
