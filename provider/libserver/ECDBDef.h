...
#define Z_TABLEDEF_MVPROPERTIES \
	"CREATE TABLE `mvproperties` ( \
...
#define Z_TABLEDEF_DEFERREDUPDATE \
	"CREATE TABLE `deferredupdate` (\
...
#define Z_TABLEDEF_RECEIVEFOLDER \
	"CREATE TABLE `receivefolder` (  \
		`id` int(11) unsigned NOT NULL auto_increment, \
...
#define Z_TABLEDEF_OBJECT_PROPERTY \
...
#define Z_TABLEDEF_OBJECT_RELATION \
...
#define Z_TABLEDEF_SEARCHRESULTS \
...
#define Z_TABLEDEF_ABCHANGES \
	"CREATE TABLE `abchanges` ( \
		`id` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT, \
...
#define Z_TABLEDEFS_SYNCEDMESSAGES \
...
#define Z_TABLEDEF_INDEXED_PROPERTIES \
...
#define Z_TABLEDATA_ACL \
	"INSERT INTO `acl` VALUES (2, 2, 2, 1531), \
		(2, 1, 2, 1531), \
		(1, 1, 2, 1531), \
		(1, 2, 2, 1531);"

#define Z_TABLEDATA_HIERARCHY \
	"INSERT INTO `hierarchy` VALUES \
	(1, NULL, 1, 0, 2), \
	(2, 1, 3, 0, 2);"

#define Z_TABLEDATA_PROPERTIES \
...
#define Z_TABLEDATA_STORES \
	"INSERT INTO `stores` VALUES (1, 1, 2, 0, 'SYSTEM', 0, 0x8962ffeffb7b4d639bc5967c4bb58234);"

//1=KOPANO_UID_EVERYONE, 0x30002=DISTLIST_SECURITY
//2=KOPANO_UID_SYSTEM, 0x10001=ACTIVE_USER
#define Z_TABLEDATA_USERS \
	"INSERT INTO `users` (`id`, `externid`, `objectclass`, `signature`, `company`) VALUES \
	(1, NULL, 0x30002, '', 0), \
	(2, NULL, 0x10001, '', 0);"

#define Z_TABLEDATA_INDEXED_PROPERTIES \
	"INSERT INTO `indexedproperties` VALUES (1, 4095, 0x000000008962ffeffb7b4d639bc5967c4bb5823400000000010000000100000000000000), \
