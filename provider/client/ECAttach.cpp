...
{
	return Util::DoCopyTo(&IID_IAttachment, static_cast<IAttach *>(&this->m_xAttach), ciidExclude, rgiidExclude, lpExcludeProps, ulUIParam, lpProgress, lpInterface, lpDestObj, ulFlags, lppProblems);
}
