...
private:
	...
	_kc_hidden HRESULT HrExpandGroup(LPADRBOOK, LPSPropValue grp_name, LPSPropValue grp_eid, vmime::mailboxList &recips, std::set<std::wstring> &s_groups, std::set<std::wstring> &s_recips, bool allow_everyone);
